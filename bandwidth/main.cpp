...
float Par(uint64_t len, int64_t block_size);
float Seq(uint64_t len, int64_t block_size);
...
{
    int64_t start_len = 1024 * 1024 * 16 / sizeof(int); // 16 MB
    int start_block_size = CACHE_LINE_SIZE;
    int max_threads = omp_get_max_threads();
    cout << "max_threads : " << max_threads << endl;
    long max_array_len = 1024 * 1024 * 1024 / sizeof(int); // 10240 MB
